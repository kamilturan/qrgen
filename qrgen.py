...
import sys
import os
sys.path.append('/usr/share/qrgen')
...
class QrGen(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        # Lisans dosyasının tam yolunu belirleme
        license_path = "/usr/share/licenses/qrgen/license.dat"
        
        # Lisans dosyasını okuma
        try:
            with open(license_path, "r") as f:
                self.__license = "".join(f.readlines())
        except FileNotFoundError:
            self.__license = "Lisans dosyası bulunamadı."
